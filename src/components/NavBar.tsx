...
export default function NavBarComponent() {
  ...
  return (
    <div className='flex items-center justify-start sm:justify-center fixed w-full bg-white'>
      <div className='w-[90%] sm:h-[101px] h-[100px] flex items-center justify-between'>
