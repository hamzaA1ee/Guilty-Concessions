...
export default function StepOneView() {
  return (
    <>
      ...
      <Button className='text-center mt-2 justify-between text-customGray font-bold text-[14px] w-full h-[38px] border-customGray border-2 rounded-3xl '>
        <svg
      ...
      <Button className='text-center mt-2 justify-between text-customGray font-bold text-[14px] w-full h-[38px] border-customGray border-2 rounded-3xl '>
        ...
        <p className='w-full text-center'>Sign Up with Facebook</p>
      </Button>
      <Button className='text-center mt-2 justify-between text-customGray font-bold text-[14px] w-full h-[38px] border-customGray border-2 rounded-3xl '>
        <svg
          xmlns='http://www.w3.org/2000/svg'
        ...
        <p className='w-full text-center'>Sign Up with Apple</p>
      </Button>
    </>
  );
}
