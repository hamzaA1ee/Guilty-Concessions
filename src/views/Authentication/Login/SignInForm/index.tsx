...
export default function SignInFormView() {
  return (
    <Fragment>
      ...
      <Button className='text-center mt-4 text-customGray font-bold text-[14px] w-full h-[38px] border-customGray border-2 rounded-3xl '>
      ...
      <Button className='text-center mt-2 text-customGray font-bold text-[14px] w-full h-[38px] border-customGray border-2 rounded-3xl '>
        <div className='flex items-center justify-start w-full'>
          <div className='flex items-center justify-between w-3.5/5 float-left h-auto'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
